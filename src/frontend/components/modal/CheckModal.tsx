...
const CheckModal = ({ onPassCheck, close }: Props) => {
  return (
    <>
      ...
      ></div>
      <div
        className={`${Noto_Serif_bold.className} fixed left-1/2 top-1/2 z-40 flex w-full max-w-[600px] -translate-x-1/2 -translate-y-1/2 animate-drop-in-forModal flex-col items-center justify-center rounded-md border-2 border-red bg-back lg:w-1/2`}
      >
