...
const CardMenu = ({
  ...
  return (
    <>
      <div
        className="fixed left-0 top-0 z-40 h-screen w-screen bg-black opacity-50 lg:hidden"
        onClick={close}
        onMouseEnter={onMouseEnter}
      />
      <div
        onMouseEnter={onMouseEnter}
        className="fixed bottom-0 right-0 z-40 w-screen animate-toUp-in space-y-3 overflow-hidden rounded-t-xl bg-red py-3 text-base text-back lg:absolute lg:top-full lg:h-fit lg:w-60 lg:animate-none lg:space-y-0 lg:rounded-lg lg:border lg:border-red lg:bg-back lg:py-0 lg:text-sm lg:text-red"
      >
